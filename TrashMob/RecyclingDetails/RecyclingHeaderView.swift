...
struct RecyclingHeaderView: View {
  var body: some View {
    Text("TODO: Recycling Header View")
  }
}

struct RecyclingImage: View {
...
struct RecyclingHeaderView_Previews: PreviewProvider {
  static var previews: some View {
    RecyclingHeaderView()
  }
}
